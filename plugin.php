...
"CREATE TABLE ".MPREFIX."aacgc_roster_adv(rank_id int(11) NOT NULL auto_increment,rank_name varchar(50) NOT NULL,rank_pic varchar(120) NOT NULL,rank_cat int(10) unsigned NOT NULL, PRIMARY KEY  (rank_id)) ENGINE=MyISAM;",

"CREATE TABLE ".MPREFIX."aacgc_roster_adv_cat(cat_id int(11) NOT NULL auto_increment,cat_name varchar(50) NOT NULL, PRIMARY KEY  (cat_id)) ENGINE=MyISAM;",

"CREATE TABLE ".MPREFIX."aacgc_roster_adv_members(awarded_id int(11) NOT NULL auto_increment,awarded_rank_id int(11) NOT NULL,user_id varchar(11) NOT NULL,user_location varchar(120) NOT NULL,user_age text NOT NULL,user_game text NOT NULL,user_status text NOT NULL,join_date text NOT NULL,user_duties text NOT NULL, PRIMARY KEY  (awarded_id)) ENGINE=MyISAM;",

"CREATE TABLE ".MPREFIX."aacgc_roster_adv_apps(app_id int(11) NOT NULL auto_increment,user varchar(11) NOT NULL,age text NOT NULL,location text NOT NULL,contact text NOT NULL,bio text NOT NULL,gamename text NOT NULL,questiona text NOT NULL,questionb text NOT NULL,questionc text NOT NULL,questiond text NOT NULL,questione text NOT NULL, PRIMARY KEY  (app_id)) ENGINE=MyISAM;");
